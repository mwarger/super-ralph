---
name: feature-prd
description: "Self-contained skill for feature planning: relentless intake and design document generation, producing a spec for the decompose phase."
---

# Feature Skill

> Self-contained skill for feature planning: relentless intake, design document,
> and spec handoff to the decompose phase.
...
**Announce at start:** "I'm using the feature skill for relentless intake and design document generation."
...
1. Save the design to `docs/plans/YYYY-MM-DD-<feature>-design.md`
2. Copy it to `tasks/<feature-name>-spec.md` (the decompose input)

Then output:

> Spec saved to `tasks/<feature-name>-spec.md`.
>
> To create beads and start execution, run in your terminal:
> ```
> super-ralph decompose --spec tasks/<feature-name>-spec.md
> ```
>
...
- [ ] Spec copied to `tasks/<feature-name>-spec.md`
